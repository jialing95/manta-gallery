...
| Water surface | Scalar = `wave_amplitude`; colorbar shows the full exported statistics range, while colors use a one-tenth symmetric display range for vivid playback. |
